---
name: google-styleguide-go
description: >-
  Google Go Style Guide. Go golang naming conventions
  formatting packages imports error handling interfaces
  goroutines channels testing best practices decisions.
manual: false
---

# Google Go Style Guide

Apply Google's Go style conventions when writing or reviewing
Go code. Covers the style guide, style decisions, and best
practices.

## Instructions

1. The full Google Go Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The Go style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, error handling, and other style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/go/guide.md, https://raw.githubusercontent.com/google/styleguide/gh-pages/go/decisions.md, https://raw.githubusercontent.com/google/styleguide/gh-pages/go/best-practices.md on 2026-03-04 -->
# Guide
