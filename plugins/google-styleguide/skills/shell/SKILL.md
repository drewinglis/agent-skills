---
name: google-styleguide-shell
description: >-
  Google Shell Style Guide. Shell bash sh scripting naming
  conventions formatting functions variables quoting
  conditionals loops pipes subshells error handling.
manual: false
---

# Google Shell Style Guide

Apply Google's shell scripting style conventions when writing
or reviewing shell scripts.

## Instructions

1. The full Google Shell Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The Shell style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, quoting, error handling, and other style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/shellguide.md on 2026-03-04 -->
<!--
AUTHORS:
