---
name: google-styleguide-r
description: >-
  Google R Style Guide. R programming naming conventions
  formatting functions assignment operators pipes tidyverse
  data frames vectors comments documentation.
manual: false
---

# Google R Style Guide

Apply Google's R style conventions when writing or reviewing
R code.

## Instructions

1. The full Google R Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The R style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, assignment, and other style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/Rguide.md on 2026-03-04 -->
