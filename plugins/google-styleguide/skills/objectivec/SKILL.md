---
name: google-styleguide-objectivec
description: >-
  Google Objective-C Style Guide. Objective-C ObjC naming
  conventions formatting categories protocols properties
  methods blocks ARC memory management headers imports.
manual: false
---

# Google Objective-C Style Guide

Apply Google's Objective-C style conventions when writing or
reviewing Objective-C code.

## Instructions

1. The full Google Objective-C Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The Objective-C style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, memory management, and other style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/objcguide.md on 2026-03-04 -->
# Google Objective-C Style Guide
