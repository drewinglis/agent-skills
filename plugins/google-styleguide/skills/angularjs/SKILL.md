---
name: google-styleguide-angularjs
description: >-
  Google AngularJS Style Guide. AngularJS Angular 1.x
  controllers directives services factories filters modules
  dependency injection scope naming conventions formatting.
manual: false
---

# Google AngularJS Style Guide

Apply Google's AngularJS style conventions when writing or
reviewing AngularJS code.

## Instructions

1. The full Google AngularJS Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The AngularJS style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, dependency injection, and other style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/angularjs-google-style.html on 2026-03-04 -->
...
with js_binary by default) and ANGULAR_COMPILER_FLAGS_FULL from
//javascript/angular/build_defs/build_defs for your base flags.
