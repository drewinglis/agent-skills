---
name: google-styleguide-python
description: >-
  Google Python Style Guide. Python formatting naming imports
  docstrings type annotations exceptions list comprehensions
  generators decorators classes functions modules packages.
manual: false
---

# Google Python Style Guide

Apply Google's Python style conventions when writing or
reviewing Python code.

## Instructions

1. The full Google Python Style Guide is embedded below
2. If the guide content is missing, tell the user:
   "The Python style guide hasn't been downloaded yet. Run
...
4. When writing code: follow the guide's conventions for naming,
   formatting, imports, docstrings, type annotations, and other
   style rules
...
<!-- BEGIN GUIDE CONTENT -->
<!-- Fetched from https://raw.githubusercontent.com/google/styleguide/gh-pages/pyguide.md on 2026-03-04 -->
<!--
AUTHORS:
